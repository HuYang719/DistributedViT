    ...
    ACTIVATION activation, int train)
{
    ...
    l.outputs = w*h*c;
    l.inputs = l.outputs;
    // printf("shortcut: l.w=%d, l.h=%d, l.c=%d, l.outputs=%d\n", l.w, l.h, l.c, l.outputs);
...
void forward_shortcut_layer(const layer l, network_state state)
{
    ...
    // printf("fuck l.c is %d\n", l.c);
    // printf("shortcut, add=%d, from_w = %d, from_h = %d, from_c = %d, l.w = %d, l.h = %d, l.c = %d\n",l.index,from_w, from_h, from_c, l.w, l.h, l.c);
