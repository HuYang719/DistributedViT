...
def save_fc(fp, fc_model, flag=0):
    fc_model.bias.data.numpy().tofile(fp)
    fc_model.weight.data.numpy().tofile(fp)
    if(flag==1):
        print("bias shape {},\n weight shape {}".format(fc_model.bias.data.shape, fc_model.weight.data.shape))
        print("bias is {},\n weight is {}".format(fc_model.bias.data.numpy(), fc_model.weight.data.numpy()))
